...
I used my initial sketches to gather feedback on my idea for an improved version, and I have implemented most of the suggestions I received. I created the chart with GenAI (ChatGPT) because the data from YouGov was in a PDF file, and tools like DataWrapper and Tableau could not generate the chart I envisioned based on the structure of the available dataset. I used the following prompt to create the chart:
